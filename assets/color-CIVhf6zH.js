...
}`;function Z(s,e,t){const i=s.createShader(e);if(s.shaderSource(i,t),s.compileShader(i),!s.getShaderParameter(i,s.COMPILE_STATUS))throw new Error(s.getShaderInfoLog(i));return i}function ut(s,e,t){const i=s.createProgram();if(s.attachShader(i,Z(s,35633,e)),s.attachShader(i,Z(s,35632,t)),s.linkProgram(i),!s.getProgramParameter(i,35714))throw new Error(s.getProgramInfoLog(i));return i}class gt{constructor(e,t){if(this.canvas=e,this.gl=e.getContext("webgl2",{antialias:!0,premultipliedAlpha:!1}),!this.gl)throw new Error("WebGL2 required");this.cfg=Object.assign({rows:8,cols:10,heartRateMean:85,heartRateStd:30,heartRateMin:48,heartRateMax:185,overlapPercent:15,trailLifePercent:65,maxRunsPerTrace:et,lineWidth:4,headDotRadius:10,colorCore:[0,1,0,.95],edgeSpatialFade:.06,edgeFeather:.22,viewportHorizontalPadding:.05,viewportVerticalPadding:.05,heartRateDrift:!0,heartRateDriftRange:2,heartRateDriftMinMs:6e3,heartRateDriftMaxMs:14e3,heartRateMode:"auto",manualHeartRate:85,gridSize:100,showGrid:!0,gridColor:"#00ff6a",renderWidth:null,renderHeight:null},t||{}),this._colorCore=new Float32Array(this.cfg.colorCore),this.dpr=window.devicePixelRatio||1,this.traces=[],this.runs=[],this.lastSpawnTimes=new Float64Array(P),this._buildPrograms(),this._cacheUniforms(),this._buildGeometry(),this._initTraces(),this._u_runStart=new Float32Array(A),this._u_runTraceIndex=new Int32Array(A),this._u_beatIntervals=new Float32Array(P)}setHeartRateMode(e){(e==="auto"||e==="manual")&&(this.cfg.heartRateMode=e,e==="manual"&&this.setManualHeartRate(this.cfg.manualHeartRate))}setManualHeartRate(e){if(this.cfg.manualHeartRate=Math.max(this.cfg.heartRateMin,Math.min(this.cfg.heartRateMax,e)),this.cfg.heartRateMode==="manual")for(const t of this.traces)t.baseHeartRate=this.cfg.manualHeartRate,t.heartRate=this.cfg.manualHeartRate,t.beatInterval=6e4/this.cfg.manualHeartRate,t.driftStart=0}getCurrentHeartRate(){return this.cfg.heartRateMode==="manual"?this.cfg.manualHeartRate:this.traces.length===0?this.cfg.heartRateMean:this.traces.reduce((t,i)=>t+i.heartRate,0)/this.traces.length}updateConfig(e){const t={...this.cfg};Object.assign(this.cfg,e),e.colorCore&&(this._colorCore=new Float32Array(this.cfg.colorCore)),e.heartRateMode!==void 0&&e.heartRateMode!==t.heartRateMode&&this.setHeartRateMode(e.heartRateMode),e.manualHeartRate!==void 0&&this.cfg.heartRateMode==="manual"&&this.setManualHeartRate(e.manualHeartRate),(e.rows!==t.rows||e.cols!==t.cols)&&this._rebuildTraces()}updateDimensions(e,t){this.cfg.renderWidth=e,this.cfg.renderHeight=t,this.resize()}_rebuildTraces(){this.traces=[],this.runs=[],this.lastSpawnTimes=new Float64Array(P),this._initTraces(),this._seeded=!1}_randn(){let e=0,t=0;for(;!e;)e=Math.random();for(;!t;)t=Math.random();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*t)}_initTraces(){const e=this.cfg,t=e.rows*e.cols;for(let i=0;i<t;i++){const o=this._randn();let a=e.heartRateMean+o*e.heartRateStd;a=Math.min(e.heartRateMax,Math.max(e.heartRateMin,a)),this.traces.push({initialBaseHeartRate:a,baseHeartRate:a,heartRate:a,beatInterval:6e4/a,beatCount:0,driftFrom:a,driftTo:a,driftStart:0,driftDuration:1})}}_scheduleNextDrift(e,t){const i=this.cfg,o=i.heartRateDriftRange||0,a=e.baseHeartRate-o,l=e.baseHeartRate+o;let n;do n=a+Math.random()*(l-a);while(Math.abs(n-e.heartRate)<.15);e.driftFrom=e.heartRate,e.driftTo=n,e.driftStart=t;const u=i.heartRateDriftMinMs+Math.random()*(i.heartRateDriftMaxMs-i.heartRateDriftMinMs);e.driftDuration=Math.max(1e3,u)}_updateHeartRateDrift(e){if(!(!this.cfg.heartRateDrift||this.cfg.heartRateMode!=="auto"))for(const t of this.traces){t.driftStart||this._scheduleNextDrift(t,e);const i=(e-t.driftStart)/t.driftDuration;if(i>=1)t.heartRate=t.driftTo,t.beatInterval=6e4/t.heartRate,this._scheduleNextDrift(t,e);else if(i>=0){const o=i*i*(3-2*i);t.heartRate=t.driftFrom+(t.driftTo-t.driftFrom)*o,t.beatInterval=6e4/t.heartRate}}}_initPhases(){for(const e of this.traces)e.phaseShift=Math.random()*e.beatInterval,e.phaseProgress=e.phaseShift,e._lastBeatEvalTime=0}ensureInitialRuns(e){if(!this._seeded){for(let t=0;t<this.traces.length;t++)this.runs.push({traceIndex:t,startTime:e,counted:!1});this._seeded=!0}}resize(){const e=this.cfg.renderWidth||this.canvas.clientWidth||window.innerWidth,t=this.cfg.renderHeight||this.canvas.clientHeight||window.innerHeight;(this.canvas.width!==e*this.dpr||this.canvas.height!==t*this.dpr)&&(this.canvas.width=e*this.dpr,this.canvas.height=t*this.dpr,this.canvas.style.width=e+"px",this.canvas.style.height=t+"px",this.canvas.style.display="block")}_buildPrograms(){const e=this.gl;this.progTrace=ut(e,ft,ht)}_cacheUniforms(){const e=this.gl,t=this.progTrace,i=["u_time","u_t_cols","u_t_rows","u_t_canvasW","u_t_canvasH","u_t_cellMargin","u_t_pathW","u_t_pathH","u_edgeFade","u_trailVisibleFrac","u_trailFadeFrac","u_t_flipY","u_edgeFeather","u_noiseAmp","u_beatInterval","u_runStart","u_runTraceIndex","u_colCore","u_isHeadPass","u_lineHalfWidth","u_viewportHorizontalPadding","u_viewportVerticalPadding"];this._uloc={};for(const o of i)this._uloc[o]=e.getUniformLocation(t,o)}_buildGeometry(){if(!J())return;const{sampled:e,viewBox:t}=ct();this.pathBox=t;const i=e.length,o=new Float32Array(i*2*7);let a=0;for(let r=0;r<i;r++){const c=e[r],v=e[r&&r-1],b=e[r<i-1?r+1:r];let R=c.x-v.x,T=c.y-v.y;const I=Math.hypot(R,T)||1;R/=I,T/=I;let y=b.x-c.x,C=b.y-c.y;const M=Math.hypot(y,C)||1;y/=M,C/=M;const F=Math.min(1,Math.hypot(y-R,C-T)*.5);let x=b.x-v.x,H=b.y-v.y;const W=Math.hypot(x,H)||1;x/=W,H/=W;const E=-H,X=x;for(let S=-1;S<=1;S+=2)o[a++]=c.x,o[a++]=c.y,o[a++]=c.norm,o[a++]=S,o[a++]=E,o[a++]=X,o[a++]=F}const l=new Uint16Array((i-1)*6);for(let r=0,c=0;r<i-1;r++){const v=2*r,b=2*r+1,R=2*(r+1),T=2*(r+1)+1;l[c++]=v,l[c++]=b,l[c++]=R,l[c++]=b,l[c++]=T,l[c++]=R}this.vertCount=i*2,this.indexType=this.gl.UNSIGNED_SHORT,this.indexCount=l.length;const n=this.gl;this.vaoTrace=n.createVertexArray(),n.bindVertexArray(this.vaoTrace),this.vboTrace=n.createBuffer(),n.bindBuffer(n.ARRAY_BUFFER,this.vboTrace),n.bufferData(n.ARRAY_BUFFER,o,n.STATIC_DRAW);const u=28;let h=0;n.enableVertexAttribArray(0),n.vertexAttribPointer(0,2,n.FLOAT,!1,u,h),h+=8,n.enableVertexAttribArray(1),n.vertexAttribPointer(1,1,n.FLOAT,!1,u,h),h+=4,n.enableVertexAttribArray(2),n.vertexAttribPointer(2,1,n.FLOAT,!1,u,h),h+=4,n.enableVertexAttribArray(3),n.vertexAttribPointer(3,2,n.FLOAT,!1,u,h),h+=8,n.enableVertexAttribArray(4),n.vertexAttribPointer(4,1,n.FLOAT,!1,u,h),this.ibo=n.createBuffer(),n.bindBuffer(n.ELEMENT_ARRAY_BUFFER,this.ibo),n.bufferData(n.ELEMENT_ARRAY_BUFFER,l,n.STATIC_DRAW),n.bindVertexArray(null)}_spawnRuns(e){const i=this.cfg.overlapPercent/100;for(let o=0;o<this.traces.length;o++){const l=this.traces[o].beatInterval*(1-i);this.lastSpawnTimes[o]||(this.lastSpawnTimes[o]=e),(e-this.lastSpawnTimes[o]>=l||!this._traceHasActive(o,e))&&(this._addRun(o,e),this.lastSpawnTimes[o]=e)}}_traceHasActive(e,t){for(const i of this.runs)if(i.traceIndex===e){const o=this.traces[e],a=o.beatInterval+this._trailDur(o)+this._trailFade(o);if(t-i.startTime<a)return!0}return!1}_addRun(e,t){let i=0,o=-1,a=1/0;for(let l=0;l<this.runs.length;l++){const n=this.runs[l];n.traceIndex===e&&(i++,n.startTime<a&&(a=n.startTime,o=l))}i>=this.cfg.maxRunsPerTrace&&o>=0&&this.runs.splice(o,1),this.runs.push({traceIndex:e,startTime:t,counted:!1})}_trailDur(e){return this.cfg.trailLifePercent/100*e.beatInterval*(350/650)}_trailFade(e){return this.cfg.trailLifePercent/100*e.beatInterval-this._trailDur(e)}step(e){if(!J())return;this.vertCount||this._buildGeometry(),this.resize(),this.ensureInitialRuns(e),this.startTime||(this.startTime=e,this._phased||(this._initPhases(),this._phased=!0)),this._updateHeartRateDrift(e),this._spawnRuns(e);for(let r=this.runs.length-1;r>=0;r--){const c=this.runs[r],v=this.traces[c.traceIndex],b=v.beatInterval+this._trailDur(v)+this._trailFade(v);e-c.startTime>b&&this.runs.splice(r,1)}for(const r of this.traces){r._lastBeatEvalTime||(r._lastBeatEvalTime=e);let c=e-r._lastBeatEvalTime;for(c<0&&(c=0),r.phaseProgress+=c;r.phaseProgress>=r.beatInterval;)r.phaseProgress-=r.beatInterval,r.beatCount++;r._lastBeatEvalTime=e}const t=this.gl;t.viewport(0,0,this.canvas.width,this.canvas.height),t.disable(t.DEPTH_TEST),t.enable(t.BLEND),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT);const i=this.cfg,o=Math.min(this.runs.length,A);for(let r=0;r<o;r++){const c=this.runs[r];this._u_runStart[r]=c.startTime,this._u_runTraceIndex[r]=c.traceIndex}for(let r=o;r<A;r++)this._u_runStart[r]=0,this._u_runTraceIndex[r]=0;for(let r=0;r<this.traces.length;r++)this._u_beatIntervals[r]=this.traces[r].beatInterval;for(let r=this.traces.length;r<P;r++)this._u_beatIntervals[r]=0;t.useProgram(this.progTrace),t.bindVertexArray(this.vaoTrace);const a=r=>this._uloc[r];t.uniform1f(a("u_time"),e),t.uniform1i(a("u_t_cols"),i.cols),t.uniform1i(a("u_t_rows"),i.rows),t.uniform1f(a("u_t_canvasW"),this.canvas.width),t.uniform1f(a("u_t_canvasH"),this.canvas.height),t.uniform1f(a("u_t_cellMargin"),4),t.uniform1f(a("u_t_pathW"),this.pathBox.width),t.uniform1f(a("u_t_pathH"),this.pathBox.height),t.uniform1f(a("u_viewportHorizontalPadding"),i.viewportHorizontalPadding),t.uniform1f(a("u_viewportVerticalPadding"),i.viewportVerticalPadding),t.uniform1f(a("u_edgeFade"),i.edgeSpatialFade);const l=Math.min(.95,Math.max(.05,this.cfg.trailLifePercent/100)),n=l*(350/650),u=Math.max(1e-4,l-n);t.uniform1f(a("u_trailVisibleFrac"),n),t.uniform1f(a("u_trailFadeFrac"),u),t.uniform1i(a("u_t_flipY"),1),t.uniform1f(a("u_edgeFeather"),i.edgeFeather),t.uniform1f(a("u_noiseAmp"),.35),t.uniform1fv(a("u_beatInterval"),this._u_beatIntervals),t.uniform1fv(a("u_runStart"),this._u_runStart),t.uniform1iv(a("u_runTraceIndex"),this._u_runTraceIndex),t.uniform4fv(a("u_colCore"),this._colorCore),t.blendFunc(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA),t.uniform1i(a("u_isHeadPass"),0),t.uniform1f(a("u_lineHalfWidth"),i.lineWidth*.5),t.drawElementsInstanced(t.TRIANGLES,this.indexCount,this.indexType,0,o),t.blendFunc(t.SRC_ALPHA,t.ONE),t.uniform1i(a("u_isHeadPass"),1),t.uniform1f(a("u_lineHalfWidth"),(i.headDotRadius||i.lineWidth*1.4)*.5),t.drawArraysInstanced(t.POINTS,0,this.vertCount,o),t.bindVertexArray(null);const h=t.getError();h!==t.NO_ERROR&&console.warn("[MultiECGBatchGL] glError",h.toString(16))}totalBeats(){return this.traces.reduce((e,t)=>e+t.beatCount,0)}dispose(){const e=this.gl;if(e)try{this.vboTrace&&e.deleteBuffer(this.vboTrace),this.ibo&&e.deleteBuffer(this.ibo),this.vaoTrace&&e.deleteVertexArray(this.vaoTrace),this.progTrace&&e.deleteProgram(this.progTrace)}catch(t){console.warn("dispose error",t)}}}class pt{constructor(e){this.batch=e,this._running=!1,this._loop=this._loop.bind(this)}start(){this._running||(this._running=!0,requestAnimationFrame(this._loop))}stop(){this._running=!1}_loop(e){this._running&&(this.batch.step(e),requestAnimationFrame(this._loop))}}function mt(s,e){let t=s.replace("#","");t.length===3&&(t=t.split("").map(l=>l+l).join(""));const i=parseInt(t.slice(0,2),16)/255,o=parseInt(t.slice(2,4),16)/255,a=parseInt(t.slice(4,6),16)/255;return[i,o,a,e]}export{pt as B,gt as M,dt as d,_t as e,mt as h};
