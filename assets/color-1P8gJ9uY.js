const nt="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20665.19684%20283.46457'%3e%3c!--%20Extended%20baseline%20left%20(+120%20units)%20and%20right%20(+120%20units)%20around%20original%20waveform%20--%3e%3cpath%20d='M%200,212.91825%20L%20120,212.91825%20L%20127.994723,212.91825%20L%20170.295515,212.96707%20C%20170.845515,212.56298%20173.366592,209.70567%20174.432211,207.61251%20C%20176.856071,202.85141%20187.517198,192.00825%20190.761002,190.44424%20C%20193.077648,189.32726%20196.961291,190.229%20199.110464,191.3083%20C%20203.295033,193.40975%20211.684885,201.48277%20216.711179,208.07369%20L%20221.6534,212.96707%20L%20242.07837,212.91825%20L%20244.8981,219.16825%20C%20252.38138,235.75509%20253.17959,236.81027%20255.82894,233.618%20C%20256.77263,232.48092%20260.99472,136.34104%20260.99472,115.98961%20C%20260.99472,99.631005%20262.17373,115.52793%20265.47388,176.38366%20C%20267.70186,217.46813%20269.45992,242.77385%20270.14341,243.59741%20C%20270.74632,244.32387%20271.81084,244.91825%20272.509,244.91825%20C%20273.20717,244.91825%20277.61499,237.07638%20282.30415,227.49188%20L%20290.82991,210.06551%20L%20295.16232,209.50926%20C%20299.09064,209.00489%20333.09981,206.18407%20334.7929,206.19593%20C%20335.1842,206.19867%20337.39478,204.14626%20337.97796,201.98049%20C%20340.16036,193.87568%20352.73129,181.80678%20364.99472,176.04268%20C%20369.75712,173.80423%20372.12563,173.40792%20382.6558,173.08752%20C%20402.32457,172.48905%20411.59185,175.356%20422.92465,185.54516%20C%20428.83349,190.85772%20437.35747,203.28768%20438.56003,205.71063%20C%20440.98729,210.60115%20443.88177,210.44532%20447.73276,210.63559%20C%20452.44569,210.86845%20457.55213,208.80775%20460.72341,207.33241%20C%20463.14974,206.20363%20472.82566,201.84404%20478.06891,201.22306%20C%20483.54219,200.57483%20488.4693,201.66908%20498.67185,208.45172%20L%20505.46389,212.96707%20L%20534.69492,212.96707%20L%20545.19684,212.96707%20L%20665.19684,212.91825'%20fill='none'%20stroke='%2300ff00'%20stroke-width='4.25'%20stroke-linecap='round'%20stroke-linejoin='round'%20/%3e%3c/svg%3e";let Y=!1,D=null,j=[],B=null,Q=0,tt=null;const st=3200;function U(s,e){if(!s)return`rgba(0,255,106,${e})`;let t=s.replace("#","");t.length===3&&(t=t.split("").map(l=>l+l).join(""));const a=parseInt(t.substring(0,2),16),n=parseInt(t.substring(2,4),16),i=parseInt(t.substring(4,6),16);return`rgba(${a},${n},${i},${e})`}async function lt({sampleResolution:s=st}={}){if(!Y)return D||(D=(async()=>{const t=await(await fetch(nt)).text(),n=new DOMParser().parseFromString(t,"image/svg+xml");if(B=n.querySelector("path"),!B)throw new Error("Path not found in SVG");Q=B.getTotalLength();const i=n.querySelector("svg").getAttribute("viewBox").split(" ").map(Number);tt={x:i[0],y:i[1],width:i[2],height:i[3]},j=[];for(let l=0;l<=s;l++){const o=l/s,u=B.getPointAtLength(o*Q);j.push({x:u.x,y:u.y,norm:o})}Y=!0})(),D)}function dt(s,e){const t=s.getContext("2d");if(!t)return;const a=s.parentElement,n=a?a.getBoundingClientRect():null,i=n?n.width:s.clientWidth||s.width,l=n?n.height:s.clientHeight||s.height,o=window.devicePixelRatio||1;(s.width!==i*o||s.height!==l*o)&&(s.width=i*o,s.height=l*o,s.style.width=i+"px",s.style.height=l+"px"),t.setTransform(o,0,0,o,0,0),t.clearRect(0,0,i,l);const{rows:u=1,cols:h=1,gridSize:r=100,gridColorMajor:c="#00ff6a",gridColorPanel:v="#00ff6a",showGridOuterBox:b=!0,showGridLines:R=!0,showGridBackground:T=!0,gridGapPercent:I=4,viewportHorizontalPadding:y=.05,viewportVerticalPadding:C=.05}=e;t.fillStyle="#0d0d0d",t.fillRect(0,0,i,l);const M=i,F=M*y,w=M*C,H=i-2*F,W=l-2*w,E=H/h,P=(u===1&&h===1?0:I)/100,$=E*P,q=E*P,at=$*(h-1),it=q*(u-1),_=(H-at)/h,p=(W-it)/u,K=r,V=Math.max(1,Math.round(_/K)),O=Math.max(1,Math.round(p/K)),G=_/V,N=p/O,L=5,rt=G/L,ot=N/L;for(let z=0;z<u;z++)for(let k=0;k<h;k++){const g=F+k*(_+$),m=w+z*(p+q);if(t.save(),t.beginPath(),t.rect(g,m,_,p),t.clip(),R){t.strokeStyle=U(c,.12),t.lineWidth=1;for(let f=0;f<V;f++)for(let d=1;d<L;d++){const x=g+f*G+d*rt;x>=g+_-.5||(t.beginPath(),t.moveTo(x,m),t.lineTo(x,m+p),t.stroke())}for(let f=0;f<O;f++)for(let d=1;d<L;d++){const x=m+f*N+d*ot;x>=m+p-.5||(t.beginPath(),t.moveTo(g,x),t.lineTo(g+_,x),t.stroke())}t.strokeStyle=U(c,.12),t.lineWidth=1;for(let f=1;f<V;f++){const d=g+f*G;d>=g+_-.5||(t.beginPath(),t.moveTo(d,m),t.lineTo(d,m+p),t.stroke())}for(let f=1;f<O;f++){const d=m+f*N;d>=m+p-.5||(t.beginPath(),t.moveTo(g,d),t.lineTo(g+_,d),t.stroke())}}if(t.restore(),T){const f=t.createRadialGradient(g+_*.55,m+p*.5,0,g+_*.55,m+p*.5,Math.max(_,p)*.45);f.addColorStop(0,"rgba(0,255,106,0.055)"),f.addColorStop(.45,"rgba(0,255,106,0.015)"),f.addColorStop(1,"rgba(0,255,106,0)"),t.fillStyle=f,t.fillRect(g,m,_,p)}b&&(t.strokeStyle=U(v,.24),t.lineWidth=.75,t.strokeRect(g+.35,m+.35,_-.7,p-.7))}}async function _t(s){await lt(s||{})}function ct(){return{sampled:j,viewBox:tt}}function J(){return Y}const S=300,et=3,A=S*et,ft=`#version 300 es
...
uniform float u_beatInterval[${S}];
...
}`;function Z(s,e,t){const a=s.createShader(e);if(s.shaderSource(a,t),s.compileShader(a),!s.getShaderParameter(a,s.COMPILE_STATUS))throw new Error(s.getShaderInfoLog(a));return a}function ut(s,e,t){const a=s.createProgram();if(s.attachShader(a,Z(s,35633,e)),s.attachShader(a,Z(s,35632,t)),s.linkProgram(a),!s.getProgramParameter(a,35714))throw new Error(s.getProgramInfoLog(a));return a}class pt{constructor(e,t){if(this.canvas=e,this.gl=e.getContext("webgl2",{antialias:!0,premultipliedAlpha:!1}),!this.gl)throw new Error("WebGL2 required");this.cfg=Object.assign({rows:8,cols:10,heartRateMean:85,heartRateStd:30,heartRateMin:48,heartRateMax:185,overlapPercent:15,trailLifePercent:65,maxRunsPerTrace:et,lineWidth:4,headDotRadius:10,colorCore:[0,1,0,.95],edgeSpatialFade:.06,edgeFeather:.22,viewportHorizontalPadding:.05,viewportVerticalPadding:.05,heartRateDrift:!0,heartRateDriftRange:2,heartRateDriftMinMs:6e3,heartRateDriftMaxMs:14e3,heartRateMode:"auto",manualHeartRate:85,gridSize:100,showGrid:!0,gridColor:"#00ff6a",renderWidth:null,renderHeight:null},t||{}),this._colorCore=new Float32Array(this.cfg.colorCore),this.dpr=window.devicePixelRatio||1,this.traces=[],this.runs=[],this.lastSpawnTimes=new Float64Array(S),this._buildPrograms(),this._cacheUniforms(),this._buildGeometry(),this._initTraces(),this._u_runStart=new Float32Array(A),this._u_runTraceIndex=new Int32Array(A),this._u_beatIntervals=new Float32Array(S)}setHeartRateMode(e){(e==="auto"||e==="manual")&&(this.cfg.heartRateMode=e,e==="manual"&&this.setManualHeartRate(this.cfg.manualHeartRate))}setManualHeartRate(e){if(this.cfg.manualHeartRate=Math.max(this.cfg.heartRateMin,Math.min(this.cfg.heartRateMax,e)),this.cfg.heartRateMode==="manual")for(const t of this.traces)t.baseHeartRate=this.cfg.manualHeartRate,t.heartRate=this.cfg.manualHeartRate,t.beatInterval=6e4/this.cfg.manualHeartRate,t.driftStart=0}getCurrentHeartRate(){return this.cfg.heartRateMode==="manual"?this.cfg.manualHeartRate:this.traces.length===0?this.cfg.heartRateMean:this.traces.reduce((t,a)=>t+a.heartRate,0)/this.traces.length}updateConfig(e){const t={...this.cfg};Object.assign(this.cfg,e),e.colorCore&&(this._colorCore=new Float32Array(this.cfg.colorCore)),e.heartRateMode!==void 0&&e.heartRateMode!==t.heartRateMode&&this.setHeartRateMode(e.heartRateMode),e.manualHeartRate!==void 0&&this.cfg.heartRateMode==="manual"&&this.setManualHeartRate(e.manualHeartRate),(e.rows!==void 0&&e.rows!==t.rows||e.cols!==void 0&&e.cols!==t.cols)&&this._rebuildTraces()}updateDimensions(e,t){this.cfg.renderWidth=e,this.cfg.renderHeight=t,this.resize()}_rebuildTraces(){this.traces=[],this.runs=[],this.lastSpawnTimes=new Float64Array(S),this._initTraces(),this._seeded=!1}_randn(){let e=0,t=0;for(;!e;)e=Math.random();for(;!t;)t=Math.random();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*t)}_initTraces(){const e=this.cfg,t=e.rows*e.cols;for(let a=0;a<t;a++){const n=this._randn();let i=e.heartRateMean+n*e.heartRateStd;i=Math.min(e.heartRateMax,Math.max(e.heartRateMin,i)),this.traces.push({initialBaseHeartRate:i,baseHeartRate:i,heartRate:i,beatInterval:6e4/i,beatCount:0,driftFrom:i,driftTo:i,driftStart:0,driftDuration:1})}}_scheduleNextDrift(e,t){const a=this.cfg,n=a.heartRateDriftRange||0,i=e.baseHeartRate-n,l=e.baseHeartRate+n;let o;do o=i+Math.random()*(l-i);while(Math.abs(o-e.heartRate)<.15);e.driftFrom=e.heartRate,e.driftTo=o,e.driftStart=t;const u=a.heartRateDriftMinMs+Math.random()*(a.heartRateDriftMaxMs-a.heartRateDriftMinMs);e.driftDuration=Math.max(1e3,u)}_updateHeartRateDrift(e){if(!(!this.cfg.heartRateDrift||this.cfg.heartRateMode!=="auto"))for(const t of this.traces){t.driftStart||this._scheduleNextDrift(t,e);const a=(e-t.driftStart)/t.driftDuration;if(a>=1)t.heartRate=t.driftTo,t.beatInterval=6e4/t.heartRate,this._scheduleNextDrift(t,e);else if(a>=0){const n=a*a*(3-2*a);t.heartRate=t.driftFrom+(t.driftTo-t.driftFrom)*n,t.beatInterval=6e4/t.heartRate}}}_initPhases(){for(const e of this.traces)e.phaseShift=Math.random()*e.beatInterval,e.phaseProgress=e.phaseShift,e._lastBeatEvalTime=0}ensureInitialRuns(e){if(!this._seeded){for(let t=0;t<this.traces.length;t++)this.runs.push({traceIndex:t,startTime:e,counted:!1});this._seeded=!0}}resize(){const e=this.cfg.renderWidth||this.canvas.clientWidth||window.innerWidth,t=this.cfg.renderHeight||this.canvas.clientHeight||window.innerHeight;(this.canvas.width!==e*this.dpr||this.canvas.height!==t*this.dpr)&&(this.canvas.width=e*this.dpr,this.canvas.height=t*this.dpr,this.canvas.style.width=e+"px",this.canvas.style.height=t+"px",this.canvas.style.display="block")}_buildPrograms(){const e=this.gl;this.progTrace=ut(e,ft,ht)}_cacheUniforms(){const e=this.gl,t=this.progTrace,a=["u_time","u_t_cols","u_t_rows","u_t_canvasW","u_t_canvasH","u_t_cellMargin","u_t_pathW","u_t_pathH","u_edgeFade","u_trailVisibleFrac","u_trailFadeFrac","u_t_flipY","u_edgeFeather","u_noiseAmp","u_beatInterval","u_runStart","u_runTraceIndex","u_colCore","u_isHeadPass","u_lineHalfWidth","u_viewportHorizontalPadding","u_viewportVerticalPadding"];this._uloc={};for(const n of a)this._uloc[n]=e.getUniformLocation(t,n)}_buildGeometry(){if(!J())return;const{sampled:e,viewBox:t}=ct();this.pathBox=t;const a=e.length,n=new Float32Array(a*2*7);let i=0;for(let r=0;r<a;r++){const c=e[r],v=e[r&&r-1],b=e[r<a-1?r+1:r];let R=c.x-v.x,T=c.y-v.y;const I=Math.hypot(R,T)||1;R/=I,T/=I;let y=b.x-c.x,C=b.y-c.y;const M=Math.hypot(y,C)||1;y/=M,C/=M;const F=Math.min(1,Math.hypot(y-R,C-T)*.5);let w=b.x-v.x,H=b.y-v.y;const W=Math.hypot(w,H)||1;w/=W,H/=W;const E=-H,X=w;for(let P=-1;P<=1;P+=2)n[i++]=c.x,n[i++]=c.y,n[i++]=c.norm,n[i++]=P,n[i++]=E,n[i++]=X,n[i++]=F}const l=new Uint16Array((a-1)*6);for(let r=0,c=0;r<a-1;r++){const v=2*r,b=2*r+1,R=2*(r+1),T=2*(r+1)+1;l[c++]=v,l[c++]=b,l[c++]=R,l[c++]=b,l[c++]=T,l[c++]=R}this.vertCount=a*2,this.indexType=this.gl.UNSIGNED_SHORT,this.indexCount=l.length;const o=this.gl;this.vaoTrace=o.createVertexArray(),o.bindVertexArray(this.vaoTrace),this.vboTrace=o.createBuffer(),o.bindBuffer(o.ARRAY_BUFFER,this.vboTrace),o.bufferData(o.ARRAY_BUFFER,n,o.STATIC_DRAW);const u=28;let h=0;o.enableVertexAttribArray(0),o.vertexAttribPointer(0,2,o.FLOAT,!1,u,h),h+=8,o.enableVertexAttribArray(1),o.vertexAttribPointer(1,1,o.FLOAT,!1,u,h),h+=4,o.enableVertexAttribArray(2),o.vertexAttribPointer(2,1,o.FLOAT,!1,u,h),h+=4,o.enableVertexAttribArray(3),o.vertexAttribPointer(3,2,o.FLOAT,!1,u,h),h+=8,o.enableVertexAttribArray(4),o.vertexAttribPointer(4,1,o.FLOAT,!1,u,h),this.ibo=o.createBuffer(),o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,this.ibo),o.bufferData(o.ELEMENT_ARRAY_BUFFER,l,o.STATIC_DRAW),o.bindVertexArray(null)}_spawnRuns(e){const t=this.cfg;for(let a=0;a<this.traces.length;a++){const n=this.traces[a],i=Math.max(0,Math.min(100,t.overlapPercent||0)),l=n.beatInterval*(1-i/100);this.lastSpawnTimes[a]||(this.lastSpawnTimes[a]=e),(e-this.lastSpawnTimes[a]>=l||!this._traceHasActive(a,e))&&(this._addRun(a,e),this.lastSpawnTimes[a]=e)}}_traceHasActive(e,t){for(const a of this.runs)if(a.traceIndex===e){const n=this.traces[e],i=n.beatInterval+this._trailDur(n)+this._trailFade(n);if(t-a.startTime<i)return!0}return!1}_addRun(e,t){let a=0,n=-1,i=1/0;for(let l=0;l<this.runs.length;l++){const o=this.runs[l];o.traceIndex===e&&(a++,o.startTime<i&&(i=o.startTime,n=l))}a>=this.cfg.maxRunsPerTrace&&n>=0&&this.runs.splice(n,1),this.runs.push({traceIndex:e,startTime:t,counted:!1})}_trailDur(e){return this.cfg.trailLifePercent/100*e.beatInterval*(350/650)}_trailFade(e){return this.cfg.trailLifePercent/100*e.beatInterval-this._trailDur(e)}step(e){if(!J())return;this.vertCount||this._buildGeometry(),this.resize(),this.ensureInitialRuns(e),this.startTime||(this.startTime=e,this._phased||(this._initPhases(),this._phased=!0)),this._updateHeartRateDrift(e),this._spawnRuns(e);for(let r=this.runs.length-1;r>=0;r--){const c=this.runs[r],v=this.traces[c.traceIndex],b=v.beatInterval+this._trailDur(v)+this._trailFade(v);e-c.startTime>b&&this.runs.splice(r,1)}for(const r of this.traces){r._lastBeatEvalTime||(r._lastBeatEvalTime=e);let c=e-r._lastBeatEvalTime;for(c<0&&(c=0),r.phaseProgress+=c;r.phaseProgress>=r.beatInterval;)r.phaseProgress-=r.beatInterval,r.beatCount++;r._lastBeatEvalTime=e}const t=this.gl;t.viewport(0,0,this.canvas.width,this.canvas.height),t.disable(t.DEPTH_TEST),t.enable(t.BLEND),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT);const a=this.cfg,n=Math.min(this.runs.length,A);for(let r=0;r<n;r++){const c=this.runs[r];this._u_runStart[r]=c.startTime,this._u_runTraceIndex[r]=c.traceIndex}for(let r=n;r<A;r++)this._u_runStart[r]=0,this._u_runTraceIndex[r]=0;for(let r=0;r<this.traces.length;r++)this._u_beatIntervals[r]=this.traces[r].beatInterval;for(let r=this.traces.length;r<S;r++)this._u_beatIntervals[r]=0;t.useProgram(this.progTrace),t.bindVertexArray(this.vaoTrace);const i=r=>this._uloc[r];t.uniform1f(i("u_time"),e),t.uniform1i(i("u_t_cols"),a.cols),t.uniform1i(i("u_t_rows"),a.rows),t.uniform1f(i("u_t_canvasW"),this.canvas.width),t.uniform1f(i("u_t_canvasH"),this.canvas.height),t.uniform1f(i("u_t_cellMargin"),4),t.uniform1f(i("u_t_pathW"),this.pathBox.width),t.uniform1f(i("u_t_pathH"),this.pathBox.height),t.uniform1f(i("u_viewportHorizontalPadding"),a.viewportHorizontalPadding),t.uniform1f(i("u_viewportVerticalPadding"),a.viewportVerticalPadding),t.uniform1f(i("u_edgeFade"),a.edgeSpatialFade);const l=Math.min(.95,Math.max(.05,this.cfg.trailLifePercent/100)),o=l*(350/650),u=Math.max(1e-4,l-o);t.uniform1f(i("u_trailVisibleFrac"),o),t.uniform1f(i("u_trailFadeFrac"),u),t.uniform1i(i("u_t_flipY"),1),t.uniform1f(i("u_edgeFeather"),a.edgeFeather),t.uniform1f(i("u_noiseAmp"),.35),t.uniform1fv(i("u_beatInterval"),this._u_beatIntervals),t.uniform1fv(i("u_runStart"),this._u_runStart),t.uniform1iv(i("u_runTraceIndex"),this._u_runTraceIndex),t.uniform4fv(i("u_colCore"),this._colorCore),t.blendFunc(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA),t.uniform1i(i("u_isHeadPass"),0),t.uniform1f(i("u_lineHalfWidth"),a.lineWidth*.5),t.drawElementsInstanced(t.TRIANGLES,this.indexCount,this.indexType,0,n),t.blendFunc(t.SRC_ALPHA,t.ONE),t.uniform1i(i("u_isHeadPass"),1),t.uniform1f(i("u_lineHalfWidth"),(a.headDotRadius||a.lineWidth*1.4)*.5),t.drawArraysInstanced(t.POINTS,0,this.vertCount,n),t.bindVertexArray(null);const h=t.getError();h!==t.NO_ERROR&&console.warn("[MultiECGBatchGL] glError",h.toString(16))}totalBeats(){return this.traces.reduce((e,t)=>e+t.beatCount,0)}dispose(){const e=this.gl;if(e)try{this.vboTrace&&e.deleteBuffer(this.vboTrace),this.ibo&&e.deleteBuffer(this.ibo),this.vaoTrace&&e.deleteVertexArray(this.vaoTrace),this.progTrace&&e.deleteProgram(this.progTrace)}catch(t){console.warn("dispose error",t)}}}class gt{constructor(e){this.batch=e,this._running=!1,this._loop=this._loop.bind(this)}start(){this._running||(this._running=!0,requestAnimationFrame(this._loop))}stop(){this._running=!1}_loop(e){this._running&&(this.batch.step(e),requestAnimationFrame(this._loop))}}function mt(s,e){let t=s.replace("#","");t.length===3&&(t=t.split("").map(l=>l+l).join(""));const a=parseInt(t.slice(0,2),16)/255,n=parseInt(t.slice(2,4),16)/255,i=parseInt(t.slice(4,6),16)/255;return[a,n,i,e]}export{gt as B,pt as M,dt as d,_t as e,mt as h};
